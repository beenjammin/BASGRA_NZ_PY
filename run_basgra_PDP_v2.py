...
days_harvest = pd.read_csv(CWD/'check_basgra_python'/'test_data'/'harvest_Lincoln_1972.txt',
...
days_harvest_no_irrig.loc[:, 'reseed_trig'] = 0.75
days_harvest_no_irrig.loc[:, 'reseed_basal'] = 0.85
